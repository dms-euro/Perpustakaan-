                            ...
                            <div class="overflow-hidden rounded-2xl shadow-sm border border-gray-100 bg-white">
                                <table class="w-full text-sm text-gray-700">
                                    <thead class="bg-gray-50 text-xs uppercase text-gray-500">
                                        <tr>
                                            <th class="px-6 py-3 text-left font-semibold tracking-wide">Kategori</th>
                                            <th class="px-6 py-3 text-left font-semibold tracking-wide w-24">Aksi</th>
                                        </tr>
                                    </thead>
                                        ...
                                        @forelse ($kategori as $k)
                                            <tr class="hover:bg-emerald-50 transition-colors">
                                                <td class="px-6 py-4 flex items-center gap-1">
                                                    <i class='bx bx-collection text-emerald-600 text-xl'></i>
                                                    <span class="font-medium text-gray-800">{{ $k->kategori }}</span>
                                                </td>
                                                <td class="px-6 py-4">
                                                    <form action="#" method="POST">
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="inline-flex items-center px-2 py-1 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-md transition">
                            ...
                            @forelse ($buku as $b)
                                <tr class="hover:bg-emerald-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <button class="px-3 py-1 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm">
                                            Hapus
                                        </button>
                                    </td>
                                </tr>
