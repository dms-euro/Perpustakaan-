   ...
   <div class="lg:ml-64 pt-24">
    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="text-center mb-12">
            <div class="inline-flex items-center gap-3 bg-white rounded-2xl px-6 py-4 shadow-sm border border-gray-200 mb-4">
                ...
                <div class="text-left">
                    ...
                    <p class="text-gray-600 mt-1">Informasi lengkap data anggota perpustakaan</p>
                </div>
            </div>
        </div>
                ...
                <div class="sticky top-8 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                        <div class="text-center">
                            <div class="w-24 h-24 bg-emerald-100 rounded-full mx-auto mb-4 flex items-center justify-center border-4 border-white shadow-md">
                                <i class='bx bx-user text-emerald-600 text-3xl'></i>
                            </div>
                            <h2 class="text-xl font-bold text-gray-800 mb-2">{{ $anggota->nama }}</h2>
            ...
            <div class="flex-1">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-4 p-4 hover:bg-gray-50 rounded-xl transition-colors duration-200 border border-gray-100">
                            ...
                            <div class="flex items-center gap-4 p-4 hover:bg-gray-50 rounded-xl transition-colors duration-200 border border-gray-100">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="font-semibold text-gray-800">{{ $anggota->telepon ?? '-' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div class="p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
                                ...
                                <div class="flex items-center gap-3 mt-2">
                                    ...
                                    <p class="text-lg font-bold text-gray-800">{{ ucfirst($anggota->role) }}</p>
                                </div>
                            </div>
                            ...
                            <div class="p-4 bg-gray-50 border border-gray-200 rounded-xl">
                                ...
                                <div class="flex items-center gap-3 mt-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">Terdaftar sejak {{ $anggota->created_at->format('M Y') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 bg-gray-50 border border-gray-200 rounded-xl">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-600 leading-relaxed">{{ $anggota->alamat ?? 'Alamat belum diisi' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-4 bg-blue-50 border border-blue-200 rounded-xl">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800">{{ $anggota->created_at->format('d M Y, H:i') }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-4 bg-purple-50 border border-purple-200 rounded-xl">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-800">{{ $anggota->updated_at->format('d M Y, H:i') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-3 justify-end">
                    ...
                    <button class="px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition duration-200 font-semibold flex items-center gap-2 shadow-sm">
