@extends('layouts.app')
@section('page-title', 'Manajemen User & Akun')
@section('content')
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex items-center gap-2 text-sm text-gray-500">
                            ...
                            <span>Terakhir update: {{ $akun->updated_at->format('d M Y H:i') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="sticky top-8 space-y-6">
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                            <div class="text-center">
                                <div
                                    class="w-20 h-20 bg-gradient-to-r from-emerald-400 to-teal-500 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                                    <i class='bx bx-user text-white text-2xl'></i>
                                </div>
                                <h3 class="font-bold text-gray-800">{{ $akun->nama }}</h3>
                                <p class="text-gray-600 text-sm mt-1">{{ $akun->email }}</p>
                                <div class="mt-3">
                                    <span
                                        class="inline-flex items-center px-3 py-1 bg-emerald-100 text-emerald-800 rounded-full text-xs font-semibold">
                                        {{ ucfirst($akun->role) }}
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-medium text-gray-800">{{ $akun->created_at->format('d M Y') }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Update Terakhir</span>
                                    <span class="font-medium text-gray-800">{{ $akun->updated_at->format('d M Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div id="personal-info"
                                ...
                                <div class="p-6">
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-3">Nomor
                                                Telepon</label>
                                            <input type="text" name="telepon"
                                                value="{{ old('telepon', $akun->telepon) }}" required
                                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200"
                                        ...
                                        <div>
                                            ...
                                            <select name="role" required
                                                ...
                                                <option value="admin"
                                                    {{ old('role', $akun->role) == 'admin' ? 'selected' : '' }}>Admin
                                                </option>
                                                <option value="petugas"
                                                    {{ old('role', $akun->role) == 'petugas' ? 'selected' : '' }}>Petugas
                                                </option>
                                                <option value="anggota"
                                                    {{ old('role', $akun->role) == 'anggota' ? 'selected' : '' }}>Anggota
                                                </option>
                                            </select>
                                            @error('role')
                                                <p class="text-red-500 text-sm mt-2 flex items-center gap-2">
                                        ...
                                        @if ($akun->role == 'anggota')
                                            <div>
                                                ...
                                                <input type="text" name="kelas"
                                                    value="{{ old('email', $akun->kelas) }}" required
                                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200"
                                                    placeholder="contoh@email.com">
                                            </div>
                                        @endif
                                        ...
                                        <div class="lg:col-span-2">
                                            ...
                                            <textarea name="alamat" rows="3" required
                                                ...
                                                placeholder="Masukkan alamat lengkap">{{ old('alamat', $akun->alamat) }}</textarea>
                                            @error('alamat')
                                                <p class="text-red-500 text-sm mt-2 flex items-center gap-2">
                                                    <i class='bx bx-error-circle'></i>{{ $message }}
                                                </p>
                            ...
                            <div id="account-security"
                                ...
                                <div class="p-6">
                                    <div class="gap-6">
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-3">Password
                                                Baru</label>
                                    ...
                                    <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-blue-700 mt-1">Password harus mengandung minimal 8
                                                    karakter dengan kombinasi huruf, angka, dan simbol.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{-- Action Buttons --}}
                            <div class="flex flex-col sm:flex-row gap-4 pt-6 pb-6">
