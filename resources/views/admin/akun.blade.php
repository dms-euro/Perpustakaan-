@extends('layouts.app')
@section('page-title', 'Manajemen Akun User')
@section('content')
        ...
        <main class="p-6">
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden" data-aos="fade-up">
                ...
                <div
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-emerald-900">Daftar Akun User</h3>
                        <p class="text-sm text-gray-600">Manajemen Akun</p>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-4 w-full md:w-auto">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="search-akun" placeholder="Cari Akun..."
                        ...
                        <button data-modal-target="akunModal" data-modal-toggle="akunModal"
                            ...
                            <i class='bx bx-user-plus text-lg'></i> Tambah Akun
                        </button>
                    </div>
                </div>
            ...
            <div class="relative bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                ...
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Lengkapi form berikut untuk menambahkan akun baru</p>
                    </div>
                </div>

                <!-- Form -->
                <form id="bukuForm" action="{{ route('akun.store') }}" method="POST" id="add-akun-form"
